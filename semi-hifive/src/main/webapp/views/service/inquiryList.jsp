<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.List, com.semi.sc.model.dto.Inquiry" %>
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/service/inquiryList.css">
<div class="ServiceCenter">
	<div class="inquiryHead">
		<h2 class="ServiceHead">1:1 문의하기</h2>
		<button class="contentBtn" onclick="location.href='<%=request.getContextPath()%>/service/inquiryInsert.do'">
			문의글
