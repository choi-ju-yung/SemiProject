	...
	<div class="ServiceCenter">
		<div id="reportHead">
			...
			<button class="contentBtn"
				onclick="location.href='<%=request.getContextPath()%>/service/reportInsert.do'">
				글쓰기
		...
		<div class="boardContainer">
			<table>
				...
				<tr class="titleList" onclick="location.href='<%=request.getContextPath()%>'">
					<td><%=r.getReportNo() %></td>
					<td><ion-icon name="lock-closed-outline"></ion-icon></td>
					<td class="reportTitle"><%=r.getReportTitle() %></td>
