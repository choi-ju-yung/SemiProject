<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.List,com.semi.product.model.vo.Product,com.semi.product.model.vo.ProductFile"%>
		...
		<div class="title">
			...
			<div class="productTitle">
				<h4 class="h4Size">제목 *</h4>
					<input type="text" placeholder="상품제목을 입력하세요" class="inputTitle" name="title" value=<%=p.getTitle()%>>
...
<!-- 			<form name="frm1"> -->
		...
		<div class="productPlace">
			...
			<input type="text" id="sample6_address" placeholder="주소" name="place" value=<%=p.getAreaName()%> readonly> 
		...
		<div class="price">
			...
			<input type="text" id="priceId" oninput="inputNumberFormat(this);" placeholder="숫자만 입력해주세요." name="price" value=<%=p.getPrice()%>>
			<p>원</p>
		</div>
		...
		<div class="explan">
			...
			<textarea id="explanId" name="explan" placeholder="여러 장의 상품 사진과 구입 연도, 브랜드, 사용감, 하자 유무 등 구매자에게 필요한 정보를 꼭 포함해 주세요. (10자 이상)"><%=p.getExplanation()%></textarea>
		</div>
