...
<%@ include file="/views/common/header.jsp"%>
    ...
    <section>
        ...
        <div class="productImg">
            ...
            <img src="<%=request.getContextPath()%>/images/productregist/imgregist.png" class="upload" width="250px" height="250px">
...
<!--             <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                ...
                <input type="text" oninput="inputNumberFormat(this);"
                placeholder="숫자만 입력해주세요.">
            <p>원</p>
        </div>
        <hr>
        ...
        <div class="explan">
            ...
            <textarea placeholder="여러 장의 상품 사진과 구입 연도, 브랜드, 사용감, 하자 유무 등 구매자에게 필요한 정보를 꼭 포함해 주세요. (10자 이상)"></textarea>
        </div>
...
<!--     	<div id="divRegistTag">
		...
		<script>location.href ="<%=request.getContextPath()%>/productRegist.do" </script>
