...
<article id="content" class="cols-d">
    <div>
        ...
        <form id="terms_form" class="f" action="">
            ...
            <textarea style="font-size:1em;" readonly>제 1장 총칙
            ...
            <textarea style="font-size:1em;" readonly>제 3장 의무 및 책임
            ...
            <textarea style="font-size:1em;" readonly>① 개인정보란 생존하는 개인에 관한 정보로서 당해 정보에 포함되어 있는 성명, 주소 등의 사항에 의하여 당해 개인을 알아볼 수 있는 부호, 문자, 음성, 음향 및 영상 등의 정보(당해 정보만으로는 특정 개인을 식별할 수 없더라도 다른 정보와 용이하게 결합하여 식별할 수 있는 것을 포함합니다)를 말합니다.

            ② 오펠골프클럽(이하 ‘회사’)은 이용자의 개인정보를 매우 중요시하며, 개인정보보호법, 정보통신망 이용촉진 및 정보보호에 관한 법률 등 개인정보보호 관련 법률 및 하위 법령들을 준수하고 있습니다.
                
            ③ 회사는 개인정보 처리방침을 통하여 귀하께서 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
                
            ④ 회사는 개인정보 처리방침의 지속적인 개선을 위하여 개정하는데 필요한 절차를 정하고 있으며, 개인정보 처리방침을 회사의 필요와 사회적 변화에 맞게 변경할 수 있습니다.
