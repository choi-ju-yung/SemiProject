...
/**
 * Servlet implementation class StatusSolAjaxServlet
 */
@WebServlet("/mypage/solBtn.do")
public class StatusSolAjaxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public StatusSolAjaxServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String pageBar = "";
		int totalData = new MypageProductService().countSellStatusSell(userId, soldOut);
		...
		List<ProductList> p = new MypageProductService().solStatusSell(cPage, numPerpage, userId);
		...
		// 버튼 클래스
		request.setAttribute("nowButton", "sol");
