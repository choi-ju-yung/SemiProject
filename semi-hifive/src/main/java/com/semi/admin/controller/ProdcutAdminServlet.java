...
@WebServlet("/productAdmin.do")
public class ProdcutAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public ProdcutAdminServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Product> productList = new AdminService().selectProdcutList(cPage,numPerpage);
